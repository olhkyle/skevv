		...
		<div className="relative">
			<MotionBlock
				...
				<label
					...
					className="flex justify-center items-center gap-2 p-4 min-h-[calc(100dvh-24px-80px)] w-full text-base text-white font-bold cursor-pointer md:min-h-[calc(100dvh-24px)] lg:p-36 lg:text-lg ">
					<FileUp size={27} />
