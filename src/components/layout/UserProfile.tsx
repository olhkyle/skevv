			...
			{userState?.user ? (
				...
				<MotionBlock className="ui-flex-center">
					<Link
						...
						className="ui-flex-center gap-0 py-3 px-3 w-full font-semibold bg-black border-[1px] border-muted text-white text-center rounded-lg cursor-pointer lg:gap-2">
						<User2 size={18} />
